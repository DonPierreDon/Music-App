<template>
  <div
    class="text-white text-centered font-bold p-4 rounded mb-4"
    v-if="log_show_alert"
...
export default {
  ...
  data() {
    return {
      ...
      log_alert_msg: "PLease wait ! your are getting logged in.",
    };
  },
  methods: {
    ...
    async login(values) {
      ...
      this.log_alert_msg = "Please wait ! your are getting logged in.";
